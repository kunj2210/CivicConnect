      ...
      <Router>
        <Routes>
          ...
          <Route
            path="/admin"
            element={
              <ProtectedRoute allowedRoles={['Admin', 'super_admin', 'hq_staff']}>
                <DashboardLayout />
              </ProtectedRoute>
            }
          >
          ...
          <Route
            path="/staff"
            element={
              <ProtectedRoute allowedRoles={['staff', 'Admin', 'super_admin', 'field_officer']}>
                <DashboardLayout />
              </ProtectedRoute>
            }
          >
          ...
          <Route
            path="/authority"
            element={
              <ProtectedRoute allowedRoles={['Authority', 'super_admin', 'dept_head']}>
                <DashboardLayout />
              </ProtectedRoute>
            }
          >
