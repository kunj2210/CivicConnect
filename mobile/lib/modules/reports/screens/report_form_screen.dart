  ...
  Future<void> _submitReport() async {
    if (_image == null || _category == null || _location == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please provide all details (image, category, location)')),
      );
      return;
    }
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        throw Exception(errorData['error'] ?? 'Failed to submit report (${response.statusCode})');
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.location_on, color: Color(0xFF0052CC)),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Text('Coordinates extracted from photo', style: TextStyle(fontSize: 12, color: Colors.grey)),
              ],
            ),
          ),
        ],
    ...
    return Column(
      children: [
        DropdownButtonFormField<String>(
          ...
          items: ['Waste Management', 'Road/Potholes', 'Street Light', 'Water Leakage', 'Other']
